...
Task("PatchVersion")
    .Does(() => 
    {
        ...
        foreach(var proj in GetFiles("src/Directory.Build.props")) 
        {
...
Task("Build")
    .Does(() => 
    {
        DotNetCoreBuild("AppMetrics.sln", new DotNetCoreBuildSettings 
        {
...
Task("UnitTest")
    .Does(() => 
    {
        foreach(var proj in GetFiles("test/**/*.Facts.csproj")) 
        {
